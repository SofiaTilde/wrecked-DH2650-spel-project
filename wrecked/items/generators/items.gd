...
func get_copper_item():
	if copperItemlist.is_empty():
		copperItemlist = [rubber_duck, screen_change, bottle_of_rum, shroom, eyepatch, anchor]
	return copperItemlist.pick_random()

func get_silver_item():
	if silverItemlist.is_empty():
		silverItemlist = [rubber_duck, screen_change, bottle_of_rum, shroom, eyepatch, anchor]
	return silverItemlist.pick_random()

func get_gold_item():
	if goldItemlist.is_empty():
		goldItemlist = [rubber_duck, screen_change, bottle_of_rum, shroom, eyepatch, anchor]
