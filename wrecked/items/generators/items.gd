...
func get_copper_item():
	if copperItemlist.is_empty():
		...
		copperItemlist = [eyepatch,bottle_of_rum,shroom,rubber_duck]
...
func get_silver_item():
	if silverItemlist.is_empty():
		...
		silverItemlist =  [eyepatch,bottle_of_rum,shroom,rubber_duck]
...
func get_gold_item():
	if goldItemlist.is_empty():
		...
		goldItemlist =  [eyepatch,bottle_of_rum,shroom,rubber_duck]
