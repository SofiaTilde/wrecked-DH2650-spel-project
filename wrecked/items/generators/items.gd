...
func get_copper_item():
	if copperItemlist.is_empty():
		...
		copperItemlist = [molotov_cocktail, dynamite, screen_change, bottle_of_rum, shroom, eyepatch, anchor, rubber_duck,parrot]
...
func get_silver_item():
	if silverItemlist.is_empty():
		...
		silverItemlist = [molotov_cocktail, dynamite, screen_change, bottle_of_rum, shroom, eyepatch, anchor, rubber_duck,parrot]
...
func get_gold_item():
	if goldItemlist.is_empty():
		...
		goldItemlist = [molotov_cocktail, dynamite, screen_change, bottle_of_rum, shroom, eyepatch, anchor, rubber_duck,parrot]
